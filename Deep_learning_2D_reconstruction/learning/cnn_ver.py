...
train_data = load('D:\\lab2\\review\\Code\\Deep_learning_2D_reconstruction\\train_data.mat')
x_train = train_data['train_data']
x_train = x_train.reshape(518,190,190,1)


train_label = load('D:\\lab2\\review\\Code\\Deep_learning_2D_reconstruction\\train_label.mat')
y_train = train_label['train_label']


test_data = load('D:\\lab2\\review\\Code\\Deep_learning_2D_reconstruction\\test_data.mat')
x_test = test_data['test_data']
x_test = x_test.reshape(24,190,190,1)


test_label = load('D:\\lab2\\review\\Code\\Deep_learning_2D_reconstruction\\test_label.mat')
y_test = test_label['test_label']

train_v = y_train[:,0:440]
...
with tf.Session() as sess:
    ...
    for i in range(1,step+1):
        ...
        sess.run(train_op, feed_dict={x: x_train, y: train_v})
        if i % 100 == 0 or i == 1:
    ...
    sio.savemat("prediction_v.mat", {"prediction_v": prediction_value})
